...
1. <b>Machine learning for geospatial data</b> - 
I’ve spent years working with maps, cities, and data. Now I’m interested in applying machine learning and multimodal models to geospatial data. Think clustering retail hubs, identifying urban hotspots, identifying perceptions from streetview or testing whether language models can “label” places in meaningful ways. These posts will be part technical experiment, part exploration of what geospatial ML can and can’t do.

2. <b>Spatial analysis and the geography of AI</b> - 
...
3. <b>Machine learning and engineering</b> - 
