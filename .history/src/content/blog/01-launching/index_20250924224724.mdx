...
I’ve spent years working with maps, cities, and data. Now I’m interested in applying machine learning and multimodal models to geospatial data. Think clustering retail hubs, predicting mobility, or testing whether language models can “label” places in meaningful ways. These posts will be part technical experiment, part exploration of what geospatial ML can and can’t do.
